...
<head>
    ...
    <title>Запущенные пластины</title>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 style = "color: #1E90FF;">Запущенные пластины</h2>
            <br/>
            <?php
            		...
            		$query = 'SELECT parcel_number, wafer_number, technology, tech_proc, time_material FROM tb_materials WHERE launched_status="YES"';
