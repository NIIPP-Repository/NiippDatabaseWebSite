...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 style = "color: #1E90FF;">Фотошаблоны</h2>
            <br/>
            <?php
            		...
            		$query = 'SELECT name, technology, tech_proc, developer, description FROM tb_set_of_masks';
